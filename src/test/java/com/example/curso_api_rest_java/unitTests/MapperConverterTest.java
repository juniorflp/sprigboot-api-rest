package com.example.curso_api_rest_java.unitTests;
...
import com.example.curso_api_rest_java.unitTestMock.MockPerson;
...
public class MapperConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = MyMapper.parseListObject(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = MyMapper.parseListObject(inputObject.mockVOList(), Person.class);
